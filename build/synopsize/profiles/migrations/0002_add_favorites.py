...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_userprofile_favorites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['profiles.userprofile'], null=False)),
            ('synopsis', models.ForeignKey(orm['synopses.synopsis'], null=False))
        ))
        db.create_unique('profiles_userprofile_favorites', ['userprofile_id', 'synopsis_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field favorites on 'UserProfile'
        db.delete_table('profiles_userprofile_favorites')
    ...
    models = {
        ...
        'profiles.userprofile': {
            ...
            'favorites': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['synopses.Synopsis']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
